 ...
 */
@Data
public class TreeAndTableQueryInvocation extends TableQueryInvocation {

    private TreeAndTableConfig treeAndTableConfig;

    public TreeAndTableQueryInvocation(IMetaObject metaObject, QueryHelper queryHelper) {
