...
(
    ...
    `auth_name`    varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '权限名',
    `auth_code`    varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '权限编码',
...
(
    ...
    `password`     varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '加密密码',
