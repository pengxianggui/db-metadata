    ...
    <el-form-item label="数据源">
      <z-toggle-panel :default-open="hasTranslation" label-position="top-left">
        ...
        <el-form label-position="top" size="mini">
          <div style="border-left: 3px solid #409EFF; padding-left: 10px; position: relative">
            <el-form-item label="指定SQL">
              <sql-box :check="true" :line-number="true" v-model="nativeValue.scopeSql"></sql-box>
            </el-form-item>
...
export default {
  ...
  data() {
    ...
    const hasTranslation = (utils.isString(value.scopeSql) && value.scopeSql.trim() !== '')
